...
from leisaac.assets.scenes.simple import STACK_THE_CUBE_CFG, STACK_THE_CUBE_USD_PATH
...
class StackCubeSceneCfg(InteractiveSceneCfg):
    """Scene configuration for the stack cube task."""

    scene: AssetBaseCfg = STACK_THE_CUBE_CFG.replace(prim_path="{ENV_REGEX_NS}/Scene")
...
class StackCubeEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the stack cube environment."""

    scene: StackCubeSceneCfg = StackCubeSceneCfg(env_spacing=8.0)
    ...
    def __post_init__(self) -> None:
        ...
        parse_usd_and_create_subassets(STACK_THE_CUBE_USD_PATH, self)
...
@configclass
class StackCubeDigitalTwinEnvCfg(StackCubeEnvCfg, ManagerBasedRLDigitalTwinEnvCfg):
    """Configuration for the stack cube digital twin environment."""
