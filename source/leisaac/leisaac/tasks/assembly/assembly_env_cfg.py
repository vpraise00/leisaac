...
from leisaac.assets.scenes.simple import ASSEMBLY_CFG, ASSEMBLY_USD_PATH
...
class AssemblySceneCfg(InteractiveSceneCfg):
    """Scene configuration for the assembly task."""

    scene: AssetBaseCfg = ASSEMBLY_CFG.replace(prim_path="{ENV_REGEX_NS}/Scene")
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        contact_forces = ObsTerm(func=mdp.contact_forces, params={"sensor_cfg": SceneEntityCfg("contact_forces")})
...
class AssemblyEnvCfg(ManagerBasedRLEnvCfg):
    ...
    scene: AssemblySceneCfg = AssemblySceneCfg(env_spacing=8.0)
    ...
    def __post_init__(self) -> None:
        ...
        parse_usd_and_create_subassets(ASSEMBLY_USD_PATH, self)
...
# @configclass
# class AssemblyDigitalTwinEnvCfg(AssemblyEnvCfg, ManagerBasedRLDigitalTwinEnvCfg):
#     """Configuration for the assembly digital twin environment."""

#     rgb_overlay_mode: str = "background"

#     rgb_overlay_paths: Dict[str, str] = {
#         "front": "greenscreen/background-stack-cube.png"
#     }
